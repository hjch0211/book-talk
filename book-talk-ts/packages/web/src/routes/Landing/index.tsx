...
export function LandingPage() {
  ...
  const heroWords = [
    { text: '사람모으기는', highlight: true },
    { text: ' 어렵고,', highlight: false },
    { text: '관심 없는 책을 ', highlight: false },
    { text: '선택하기는 싫고', highlight: true },
    { text: '혼자 읽자니', highlight: true },
    { text: ' 동기가 부족하고', highlight: false },
  ];
        ...
        <FeaturesGrid>
          ...
          <ScrollReveal delay={0}>
            <FeatureItem>
              ...
              <motion.div
                style={{ rotateX: cardA.rotateX, rotateY: cardA.rotateY, transformStyle: 'preserve-3d' }}
          ...
          <ScrollReveal delay={0.15}>
            <FeatureItem>
              ...
              <motion.div
                style={{ rotateX: cardB.rotateX, rotateY: cardB.rotateY, transformStyle: 'preserve-3d' }}
                ...
                content: (
                  <ProcessContent>
                    ...
                    <ProcessDescription>
                      ...
                      <ProcessBulletList>
                        <ProcessBodySmall>프로필을 눌러 참여자들의 발표 페이지를 다시 볼 수 있습니다.</ProcessBodySmall>
                        <ProcessBodySmall>손들기 버튼으로 손들고 발표 권한을 얻어 말할 수 있습니다.</ProcessBodySmall>
                      </ProcessBulletList>
                    </ProcessDescription>
                  </ProcessContent>
                ),
