...
import {
  type FetchOpenGraphResponse,
  FetchOpenGraphResponseSchema,
  type FindOnePresentationResponse,
  FindOnePresentationResponseSchema,
...
/** 발표 페이지 내용 수정 */
export const patchPresentationContent = async (
  id: string,
  patch: PatchContentRequest[]
): Promise<void> => {
